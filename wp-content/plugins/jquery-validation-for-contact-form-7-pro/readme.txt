...
* File upload field mimetype error fixed.
* Error message overwrite issue fixed.

= 4.0 =

* Fixed issue with latest version of Contact Form 7 ver 4.8 
